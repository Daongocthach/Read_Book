import { Typography, Box, FormControl, Select, MenuItem, Stack, Breadcrumbs, Link } from '@mui/material'
...
function GenreDetail() {
  ...
  // }, [checked])
  return (
    <Box bgcolor={(theme) => (theme.palette.mode === 'dark' ? '#363636' : '#E8E8E8')}>
      ...
      <Box sx={{ borderRadius: '6px', width: 'fit-content' }} ml={{ xs: 1, sm: 2, md: 10 }} mr={{ xs: 1, sm: 2, md: 10 }}>
